...
public class AlunoController {
    ...
    public void adicionarAluno(String cpf, String nome, String idade, String matricula, String anoIngresso) throws AlunoException {
    ...
    public void atualizarAluno(String cpfAntigo, String cpf, String nome, String idade, String matricula, String anoIngresso) throws AlunoException {
        ValidacaoAluno valid = new ValidacaoAluno();
        Aluno novoAluno = valid.validacao(cpf, nome, idade, matricula, anoIngresso);
